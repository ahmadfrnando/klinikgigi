    ...
    <nav class="bg-white shadow-lg">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <ul class="flex space-x-8 text-md">
                <li><a href="{{ route('admin.home') }}" class="text-gray-700 hover:text-green-500">Home</a></li>
                <li><a href="{{ route('admin.jadwaldokter') }}" class="text-gray-700 hover:text-green-500">Jadwal
                        Dokter</a></li>
                <li><a href="{{ route('admin.pasien') }}" class="text-gray-700 hover:text-green-500">Pasien</a></li>
                <li><a href="{{ route('admin.pengobatan') }}"
